    ...
    <div class="row">
      <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
          ...
          <dcc-cell-image id="dcc226" type="i" label="icecream2" image="https://mc-unicamp.github.io/oficinas/simula/business/image/icecream-cart.png"></dcc-cell-image>
          ...
          <rule-dcc-cell-pair id="dcc32" label="icecream moves" probability="100" transition="h.>.h">***
            *_*
            ***</rule-dcc-cell-pair>
          <rule-dcc-cell-pair id="dcc332" label="icecream2 moves" probability="100" transition="i.>.i">***
            *_*
            ***</rule-dcc-cell-pair>
          
          <rule-dcc-cell-pair id="dcc38" label="icecream sold" probability="90" transition="u.>v.">_*_
            *_*
          ...
          <rule-dcc-cell-pair id="dcc34" label="icecream sold" probability="80" transition="vh>uh" topic="icecream/sold">_*_
            *_*
            _*_</rule-dcc-cell-pair>
          <rule-dcc-cell-pair id="dcc334" label="icecream2 sold" probability="80" transition="vi>ui" topic="icecream2/sold">_*_
              *_*
              _*_</rule-dcc-cell-pair>
              ...
              <subscribe-dcc target="comp-sold-increment" topic="icecream2/sold" map="update"></subscribe-dcc>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                <p>
                Você <br/>
                R$ <dcc-expression id='last_price' expression='last_price' active></dcc-expression><br/>
                <dcc-expression id='last_quantity' expression='last_sold' active></dcc-expression><br/>
                <b>R$ <dcc-expression id='profit' expression='last_profit' active></dcc-expression></b><br/>
                <br />
                R$ <dcc-expression id='money-display' expression='money' active></dcc-expression>
                </p>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                <p>
                Concorrentes <br>
                R$ <dcc-expression id='comp_last_price' expression='comp_last_price' active></dcc-expression> <br/>
                <dcc-expression id='comp_last_quantity' expression='comp_last_sold' active></dcc-expression> <br/>
                <b>R$ <dcc-expression id='comp_profit' expression='comp_last_profit' active></dcc-expression></b><br />
                <br />
                R$ <dcc-expression id='comp-money-display' expression='comp_money' active></dcc-expression>
                </p>
            </div>
        </div>
        <br/>
